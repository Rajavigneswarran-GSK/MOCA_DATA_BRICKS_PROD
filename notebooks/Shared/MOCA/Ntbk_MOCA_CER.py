...
F_DOCUMENTS= spark.sql("""SELECT DOCUMENT_ID,DOCUMENT_NUMBER,DOCUMENT_TYPE_ID,CAMPAIGN_ID,DOCUMENT_VERSION,CONTENT_PURPOSE,ROW_NUMBER() OVER(PARTITION BY DOCUMENT_NUMBER ORDER BY DOCUMENT_VERSION DESC) AS REC_RK   FROM MOCA.F_DOCUMENTS """)
